...
Arizona is the sunniest state in the U.S., with an average of 5,755 kJ/m² in annual sunlight. In addition, there has been a +12.23% change in sunlight since 1992[^2]. Over the last 15 years, the Southwest has experience substantial drought, especially affecting the Colorado River[^3] and Lake Mead[^4]. The Colorado River supplies about 36% of Arizona's water. Whereas other sources are from groundwater, 41%; in-state rivers, 18%, and reclaimed water, 5%[^5]. Due to climate projections for the southwestern U.S., it is likely that Arizona's drought situation will only worsen over time[^6].
...
#| label: data_source
#| code-fold: true
#| code-summary: Data sources and attributionå
tags$div(
...
footer_content <- 
  tags$div(
    ...
    tags$div(
      ...
      tags$br(),
      tags$sup("3"),
      "Water is derived from the geographic area within the reservation and does not represent the amount of water allotted by water rights claims. This column serves instead to showcase the amount of water bordering or running through a reservation, but the Tribe may not have actual claims to use this water.",
      style = css(
        display = 'inline-block',
        'text-align' = 'left',
        'align-items' = 'left',
...
tribes_table <- 
  ...
  reactable(
    ...
    columns = list(
      ...
      # resolved color column (don't show)
